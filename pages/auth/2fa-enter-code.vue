  ...
  <div class="min-h-screen flex">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-12">
      <div class="w-full max-w-md text-center">
        ...
        <h2 class="text-[24px] md:text-[36px] font-bold text-[#23262F] mb-2">Two-factor Authentication</h2>
        <p class="text-[#7A7A7A] text-[14px] md:text-[16px] mb-6">Enter the four digit code sent to your email address <span
            class="font-medium">David***@gmail.com</span>.</p>
